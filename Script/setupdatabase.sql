...
INSERT INTO customer VALUES(customer_seq.NEXTVAL, 'Kasper','Hald',25,12345678,'bla@bla.dk','Java','csharp',4242,'cplusplus');
INSERT INTO customer VALUES(customer_seq.NEXTVAL, 'Simon','Gronborg',20,6666666,'bla2@bla2.dk','Python','PHP',1337,'DOTNET');
INSERT INTO customer VALUES(customer_seq.NEXTVAL, 'Thomas','Hedegaard',21,42424242,'bla2@bla3.dk','country','city',1336,'street');
INSERT INTO customer VALUES(customer_seq.NEXTVAL, 'Christoffer','mor',22,99999999,'bla2@bla4.dk','country','city',1338,'street');
...
INSERT INTO bookings VALUES(booking_seq.NEXTVAL, 1, 1, CURRENT_DATE, 6, 'CODESNIPPETS', 2000.42);
INSERT INTO bookings VALUES(booking_seq.NEXTVAL, 2, 10, CURRENT_DATE, 3, 'ASSEMBLE', 2900.42);
INSERT INTO bookings VALUES(booking_seq.NEXTVAL, 3, 42, CURRENT_DATE, 5, 'SATURN REJSER', 100.42);
INSERT INTO bookings VALUES(booking_seq.NEXTVAL, 4, 100, CURRENT_DATE, 1, 'CODEBLOCKS', 500.42);
